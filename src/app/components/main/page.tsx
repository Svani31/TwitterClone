          ...
          >
            <div className="bg-transparent pt-3 pb-3 flex gap-3 item-center text-center">
              ...
              className="rounded-3xl bg-transparent"
                ...
                width={30}
                height={50}
                alt="User Image Couldnot Load"
              />
              <h3 className="bg-transparent text-white text-2xl font-bold"> - {eachPost.user.name}</h3>
            </div>
...
// {posts.map((eachPost)=>{
//     return(
//         <div className='flex justify-center flex-col' key={eachPost.id}>
//             <h1>
//             {eachPost.title}
//             </h1>
//             <h1>
